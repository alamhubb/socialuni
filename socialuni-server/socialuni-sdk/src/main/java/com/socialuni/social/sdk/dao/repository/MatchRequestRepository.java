...
public interface MatchRequestRepository extends JpaRepository<MatchRequestDO, Integer> {
    ...
    MatchRequestDO queryMatchRequestByUserIdAndBeUserIdAndStatus(Long userId, Long receiveUserId, String status);

    MatchRequestDO queryMatchRequestByUserIdAndBeUserId(Long userId, Long receiveUserId);
}