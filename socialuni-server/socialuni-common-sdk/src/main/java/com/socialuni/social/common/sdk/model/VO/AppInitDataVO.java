package com.socialuni.social.common.sdk.model.model.VO;
...
public class AppInitDataVO {
    ...
    private List<UnreadNotifyVO> notifies;
    private List<DistrictVO> userDistricts;
    //与用户相关且无用户也要返回
    ...
    //旧版本
    private List<DistrictVO> districtProvinces;
    private Integer onlineUsersCount;
    //第一次使用时返回
    private DistrictVO district;
    private List<SocialTalkRO> talks;*/
}
