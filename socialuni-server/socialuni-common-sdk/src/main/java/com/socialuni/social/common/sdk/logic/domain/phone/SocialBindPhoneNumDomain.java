package com.socialuni.social.common.sdk.logic.domain.phone;
...
public class SocialBindPhoneNumDomain {
    ...
    public SocialuniMineUserDetailRO bindPhoneNum(SocialPhoneNumAuthCodeQO socialPhoneNumQO, SocialuniUserDo mineUser) {
