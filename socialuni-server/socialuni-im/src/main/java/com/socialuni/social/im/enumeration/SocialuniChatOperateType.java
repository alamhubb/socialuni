...
public class SocialuniChatOperateType {
    ...
    //禁言
    public final static String banned = "禁言";
    //设置为管理员
    public final static String setAdmin = "设置为管理员";
    //取消为管理员
    public final static String cancelAdmin = "取消管理员";

    public final static String join = "加入群聊";
}
