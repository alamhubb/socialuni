package com.socialuni.social.tance.dev.enumeration;
...
public class SocialFeignHeaderName {
    ...
    public static String dataOriginalSocialuniId = "dataOriginalSocialuniId";
    public static String dataUserUnionId = "dataUserUnionId";
