...
subprojects {
    ...
    dependencies {
        ...
        constraints {
            ...
            implementation("com.socialuni.social:socialuni-music-sdk:${rootProject.version}")
            implementation("com.socialuni.social:socialuni-deploy-sdk:${rootProject.version}")
            implementation("com.socialuni.social:socialuni-peiwan-sdk:${rootProject.version}")
