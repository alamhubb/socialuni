...
import com.socialuni.social.app.factory.SocialuniUserExtendDetailROFactory;
...
public class SocialuniUserExpandService {
    ...
    public ResultRO<SocialuniMineUserDetailRO> editUserSchoolName(SocialUserSchoolNameEditQO socialMineUserDetailQO) {
        ...
        String socialuniMineUserDetailRO = socialuniEditExpandDomain.editUserSchoolName(socialMineUserDetailQO);
...
//        SocialuniMineUserDetailRO socialuniMineUserDetailRO = SocialuniMineUserDetailROFactory.getMineUserDetail(socialMineUserDetailQO);
        ...
        return ResultRO.success(SocialuniMineUserDetailROFactory.getMineUserDetail());
    }

    public ResultRO<SocialuniMineUserDetailRO> editUserContactInfo(SocialUserContactInfoEditQO socialMineUserDetailQO) {

        socialuniEditExpandDomain.editUserContactInfo(socialMineUserDetailQO);
