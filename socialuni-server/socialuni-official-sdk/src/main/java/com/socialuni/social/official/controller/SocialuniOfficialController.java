...
public class SocialuniOfficialController {
    ...
    @GetMapping("login")
    public ResultRO<SocialLoginRO<SocialuniUserShowRO>> login(String name) {
        ...
        SocialLoginRO<SocialuniUserShowRO> socialLoginRO = socialuniLoginDomain.getSocialLoginROByMineUser(socialuniUserDo, SocialuniLoginType.nickname);
