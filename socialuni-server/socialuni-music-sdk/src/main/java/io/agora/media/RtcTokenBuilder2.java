...
public class RtcTokenBuilder2 {
    ...
    public String buildTokenWithUid(String appId, String appCertificate, String channelName, int uid, Role role, int token_expire, int privilege_expire) {
        return buildTokenWithUserAccount(appId, appCertificate, channelName, io.agora.media.AccessToken2.getUidStr(uid), role, token_expire, privilege_expire);
    }
    ...
    public String buildTokenWithUserAccount(String appId, String appCertificate, String channelName, String account, Role role, int token_expire, int privilege_expire) {
        io.agora.media.AccessToken2 accessToken = new io.agora.media.AccessToken2(appId, appCertificate, token_expire);
        io.agora.media.AccessToken2.Service serviceRtc = new io.agora.media.AccessToken2.ServiceRtc(channelName, account);

        serviceRtc.addPrivilegeRtc(io.agora.media.AccessToken2.PrivilegeRtc.PRIVILEGE_JOIN_CHANNEL, privilege_expire);
        if (role == Role.ROLE_PUBLISHER) {
            serviceRtc.addPrivilegeRtc(io.agora.media.AccessToken2.PrivilegeRtc.PRIVILEGE_PUBLISH_AUDIO_STREAM, privilege_expire);
            serviceRtc.addPrivilegeRtc(io.agora.media.AccessToken2.PrivilegeRtc.PRIVILEGE_PUBLISH_VIDEO_STREAM, privilege_expire);
            serviceRtc.addPrivilegeRtc(io.agora.media.AccessToken2.PrivilegeRtc.PRIVILEGE_PUBLISH_DATA_STREAM, privilege_expire);
        }
    ...
    public String buildTokenWithUid(String appId, String appCertificate, String channelName, int uid,
        ...
        return buildTokenWithUserAccount(appId, appCertificate, channelName, io.agora.media.AccessToken2.getUidStr(uid),
    ...
    public String buildTokenWithUserAccount(String appId, String appCertificate, String channelName, String account,
                                            int tokenExpire, int joinChannelPrivilegeExpire, int pubAudioPrivilegeExpire,
                                            int pubVideoPrivilegeExpire, int pubDataStreamPrivilegeExpire) {
        io.agora.media.AccessToken2 accessToken = new io.agora.media.AccessToken2(appId, appCertificate, tokenExpire);
        io.agora.media.AccessToken2.Service serviceRtc = new io.agora.media.AccessToken2.ServiceRtc(channelName, account);

        serviceRtc.addPrivilegeRtc(io.agora.media.AccessToken2.PrivilegeRtc.PRIVILEGE_JOIN_CHANNEL, joinChannelPrivilegeExpire);
        serviceRtc.addPrivilegeRtc(io.agora.media.AccessToken2.PrivilegeRtc.PRIVILEGE_PUBLISH_AUDIO_STREAM, pubAudioPrivilegeExpire);
        serviceRtc.addPrivilegeRtc(io.agora.media.AccessToken2.PrivilegeRtc.PRIVILEGE_PUBLISH_VIDEO_STREAM, pubVideoPrivilegeExpire);
