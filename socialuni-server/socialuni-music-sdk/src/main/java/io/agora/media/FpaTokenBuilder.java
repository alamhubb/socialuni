...
public class FpaTokenBuilder {
    ...
    public String buildToken(String appId, String appCertificate) {
        io.agora.media.AccessToken2 accessToken = new io.agora.media.AccessToken2(appId, appCertificate, 24 * 3600);
        io.agora.media.AccessToken2.Service serviceFpa = new io.agora.media.AccessToken2.ServiceFpa();
