<template>
  <view class="bg-white px">
    <view class="text-lg font-bold mt-xl">
      优点介绍:
    </view>
    <view class="text-lg font-bold mt-sm">
    ...
    <view class="text-lg text-orange font-bold mt-xl">
      举例填写方式：vx:491369310
    </view>
    <view class="text-lg text-orange font-bold">
      填写后可通过展示/隐藏按钮，控制别人是否能获取您的联系方式
    </view>

    <view class="text-lg text-orange font-bold mt-lg">
      了解了此功能的优点后，快去填写联系方式，更优质的处关系吧
    </view>
    <view class="text-lg text-orange font-bold mt-lg pb-lg">
