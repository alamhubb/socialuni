...
import com.socialuni.center.web.constant.LoadMoreType;
import com.socialuni.center.web.repository.ChatRepository;
import com.socialuni.center.web.repository.MessageReceiveRepository;
...
//        this.id = chatUserDO.getId();
        ...
        //如果群聊则直接使用
        if (!ChatType.systemChats.contains(chatRO.getType())) {
            SocialUserDO receiveUser = SocialUserUtil.getNotNull(chatUserDO.getReceiveUserId());
