export default class AppConfig {
    ...
    static readonly websocketUrl: string = import.meta.env.VUE_APP_WEBSOCKET_URL
    ...
    //微信商户号
    static readonly wx_app_id: string = import.meta.env.VUE_APP_WX_APP_ID
    static readonly wx_partnerid_id: string = import.meta.env.VUE_APP_WX_PARTNERID_ID
    ...
    //app相关
    static readonly qq_mp_map_key: string = import.meta.env.VUE_APP_QQ_MP_MAP_KEY
