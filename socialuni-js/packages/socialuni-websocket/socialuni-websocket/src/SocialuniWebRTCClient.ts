import SocialuniWebRTCClient from "socialuni-webrtc/src/SocialuniWebRTCClient";
...
export default class SocialuniWebsocketClient {
    ...
    static socialuniWebRTCClient: SocialuniWebRTCClient = null
