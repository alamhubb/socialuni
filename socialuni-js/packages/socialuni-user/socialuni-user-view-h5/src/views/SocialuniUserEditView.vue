    ...
    <el-form :model="socialuniUserEditViewService.editUser" label-width="70px">
      <el-form-item label="头像">
        <div class="row-col-end">
          ...
          <el-dropdown v-if="socialuniUserEditViewService.mineUser" trigger="click">
            ...
            <template #dropdown>
              <el-dropdown-menu>
                <el-dropdown-item @click.native="socialuniUserEditViewService.uploadUserAvatarImg">上传头像
                </el-dropdown-item>
      ...
      <el-form-item label="性别">
        <el-radio-group v-model="socialuniUserEditViewService.editUser.gender">
          <el-radio v-for="gender in socialuniUserEditViewService.genders" :label="gender.value">{{
              gender.label
            }}
          </el-radio>
        </el-radio-group>
