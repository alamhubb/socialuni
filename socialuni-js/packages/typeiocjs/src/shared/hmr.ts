...
export class HMRContext implements ViteHotContext {
    ...
    acceptExports(_: string | readonly string[], callback: (data: any) => void): void {
...
export class HMRClient {
    ...
    constructor(public logger: HMRLogger, connection: HMRConnection, 
    // This allows implementing reloading via different methods depending on the environment
    private importUpdatedModule: (update: Update) => Promise<ModuleNamespace>) {
        this.messenger = new HMRMessenger(connection);
    }
    public async notifyListeners<T extends string>(event: T, data: InferCustomEventPayload<T>): Promise<void>;
