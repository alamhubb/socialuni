export default class ConfigMap {
  // 系统提示
  static readonly systemError601UnLoginErrorKey: string = 'systemError601'
  static readonly systemError601Default: string = '未登录，是否跳转至登录页'

  static readonly systemError604SystemErrorKey: string = 'systemError604'
  static readonly systemError604Default: string = '有任何疑问请联系客服微信：491369310'

  static readonly systemError605UserViolationErrorKey: string = 'systemError605'
