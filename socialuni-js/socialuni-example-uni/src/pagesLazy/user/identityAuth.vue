...
import {socialUserModule} from '@socialuni/socialuni-sdk/src/store/store';
import DomFile from '@socialuni/socialuni-api/src/model/DomFile';
import SocialUserIdentityAuthPreCheckRO from "@socialuni/socialuni-api/src/model/RO/user/SocialUserIdentityAuthPreCheckRO";
import TencentCosIdInfoRO from "@socialuni/socialuni-api/src/model/RO/tencent/cos/idImgInfo/TencentCosIdInfoRO";
import QButton from "@socialuni/socialuni-view/src/components/QButton/QButton.vue";
import QIcon from "@socialuni/socialuni-view/src/components/QIcon/QIcon.vue";
import CosUtil from "@socialuni/socialuni-sdk/src/utils/CosUtil";
import SocialuniAppUtil from "@socialuni/socialuni-sdk/src/utils/UniUtil";
import MsgUtil from "@socialuni/socialuni-sdk/src/utils/MsgUtil";
import TencentCosAPI from "@socialuni/socialuni-api/src/api/TencentCosAPI";
import ToastUtil from "@socialuni/socialuni-sdk/src/utils/ToastUtil";
import SocialUserIdentityAPI from "@socialuni/socialuni-api/src/api/socialuni/SocialUserIdentityAPI";
import SocialUserIdentityAuthQO from "@socialuni/socialuni-api/src/model/QO/user/SocialUserIdentityAuthQO";
import AlertUtil from "@socialuni/socialuni-sdk/src/utils/AlertUtil";
