...
npm run serve
```
![img_3.png](src/views/guide/img_3.png)
4. 使用浏览器打开 [http://localhost:8024/](http://localhost:8024/)，出现此图，则代表项目启动成功

![img_4.png](src/views/guide/img_4.png)
...
![img_2.png](src/views/guide/img_2.png)

3. 安装成功后，启动socialuni-web项目，控制台出现以下内容则项目启动成功

![img.png](src/views/guide/img.png)
...
![img_1.png](src/views/guide/img_1.png)
