...
export default class SocialuniConfig {
  ...
  static readonly devSocialuniHttpBaseUrl = 'https://localpc.socialuni.cn:8093'
  store: Store<any>
  ...
  constructor (socialConfig?: SocialuniConfig) {
    if (socialConfig) {
      this.secretKey = socialConfig.secretKey || import.meta.env.VITE_APP_SOCIALUNI_SECRETKEY || null
