...
public class SocialUserEntity {
    ...
    public SocialuniUserModel createUserAndDetail(SocialProviderLoginQO loginQO) {
        SocialuniUserModel mineUser = socialUserManage.createUserByProviderLogin(loginQO);
        //创建或返回
