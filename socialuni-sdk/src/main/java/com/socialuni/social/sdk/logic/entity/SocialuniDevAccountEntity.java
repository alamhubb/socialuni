...
public class SocialuniDevAccountEntity {
    ...
    public SocialuniUserModel getOrCreateDevAccountUserDO(DevAccountModel devAccountModel) {
        ...
        if (socialUserPhoneModel == null) {
            ...
            mineUser = SocialuniUserUtil.getUserNotNull(socialUserPhoneModel.getUserId());
        }
        return mineUser;
    }
}
