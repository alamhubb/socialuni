...
public class AuthThirdUserEntity {
    ...
    public SocialuniMineUserDetailRO authThirdUser(SocialuniUserModel mineUser, String authType, DevAccountModel devAccountModel, SocialuniMineUserDetailRO socialMineUserDetailRO) {
        //只是记录一个授权记录
        ...
        if (AuthType.phone.equals(authType)) {
            ...
            socialMineUserDetailRO.setPhoneNum(socialUserPhoneModel.getPhoneNum());
        }
