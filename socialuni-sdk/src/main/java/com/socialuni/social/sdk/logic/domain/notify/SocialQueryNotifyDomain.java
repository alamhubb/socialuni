...
public class SocialQueryNotifyDomain {
    ...
    public List<SocialUnreadNotifyVO> queryNotifies(SocialuniUserModel mineUser) {
    ...
    public List<SocialUnreadNotifyVO> queryUnreadNotifies(SocialuniUserModel mineUser) {
    ...
    public List<SocialUnreadNotifyVO> queryUnreadNotifiesAndUpdateHasRead(SocialuniUserModel mineUser) {
        List<NotifyDO> notifyDOS = notifyRepository.findAllByReceiveUserIdAndTypeInAndHasReadFalseOrderByIdDesc(mineUser.getUnionId(), NotifyType.comments);
