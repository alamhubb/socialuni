...
public class SocialuniMineUserDetailROFactory {
    ...
    public static SocialuniMineUserDetailRO getMineUserDetail(SocialuniUserModel mineUser, SocialUserPhoneModel socialUserPhoneModel) {
        ...
        SocialuniUserExpandModel socialuniUserExpandModel = SocialuniUserExpandDOUtil.getOrCreate(mineUnionId);

        SocialuniUserSocialCoinModel socialuniUserSocialCoinModel = SocialuniUserSocialCoinDOUtil.getOrCreate(mineUnionId);

        mineUserDetailRO.setSocialCoin(socialuniUserSocialCoinModel.getSocialCoin());

        mineUserDetailRO.setOpenContactInfo(socialuniUserExpandModel.getOpenContactInfo());
