...
public class SocialPostCommentEntity {
    ...
    @Transactional
    public SocialuniCommentModel saveComment(SocialuniCommentPostQO addVO, Integer mineUserId) {
        //创建和保存comment到db
        SocialuniCommentModel commentDO = commentStore.saveAddComment(addVO, mineUserId);
