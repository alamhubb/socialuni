...
import com.socialuni.sdk.redis.HugRedis;
...
import com.socialuni.sdk.repository.community.SocialTalkCircleRepository;
...
//        Integer talkId = UnionIdDbUtil.createTalkUid(talkDO.getId(), user);
        ...
        SocialUserDO talkUser = SocialUserUtil.getUserNotNull(talkDO.getUserId());
