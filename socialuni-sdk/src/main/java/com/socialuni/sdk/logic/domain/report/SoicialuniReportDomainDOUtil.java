 ...
 */
@Service
public class SoicialuniReportDomainDOUtil {
    ...
    public void setReportRepository(ReportRepository reportRepository) {
        SoicialuniReportDomainDOUtil.reportRepository = reportRepository;
    }

    @Resource
    public void setReportDetailRepository(ReportDetailRepository reportDetailRepository) {
        SoicialuniReportDomainDOUtil.reportDetailRepository = reportDetailRepository;
    }

    @Resource
    public void setKeywordsTriggerDetailRepository(KeywordsTriggerDetailRepository keywordsTriggerDetailRepository) {
        SoicialuniReportDomainDOUtil.keywordsTriggerDetailRepository = keywordsTriggerDetailRepository;
    }

    @Resource
    public void setKeywordsTriggerService(KeywordsTriggerService keywordsTriggerService) {
        SoicialuniReportDomainDOUtil.keywordsTriggerService = keywordsTriggerService;
    }

    @Resource
    public void setUserRepository(UserRepository userRepository) {
        SoicialuniReportDomainDOUtil.userRepository = userRepository;
    }
