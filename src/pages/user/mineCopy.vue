<template>
  <view class="bg-default h100p flex-col">
      ...
      <u-popup v-model="showMoreList" mode="right" :border-radius="15">
        <view class="w65vw flex-col py-xl mt-xl h100p">
          ...
          <q-row class="flex-auto col-end">
            <view class="row-center text-bold pb-xl text-xl w100p">
    ...
    <view v-else class="h100p col-all-center bg-white">
      <!--      title="欢迎登录{{$appName}}"-->
      <u-navbar :is-back="false" title-bold>
        <view class="flex-row w100vw flex-auto">
          <view class="ml-xl text-bold text-lg w100p">
            欢迎登录{{$appName}}
          </view>
        </view>
      </u-navbar>
    ...
    <u-popup v-model="showAuthThreeAuth" mode="bottom" :border-radius="30">
      <view v-if="user" class="pb-xl px-sm pt">
        ...
        <view class="flex-row py-sm solid-bottom">
          <view class="w100p card-title pb-10px">
            <image
        ...
        <q-row class="py-xl">
          <view class="row-center w100p pt-xl">
