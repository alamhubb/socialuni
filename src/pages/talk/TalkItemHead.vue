    ...
    <view class="row-between flex-auto">
      <view>
        <view class="h25px row-col-center">
          ...
          <view v-if="!talk.globalTop" class="ml-5px cu-tag sm radius font-xs row-col-center"
          ...
          <view v-if="talk.user.vipFlag" class="ml-5px cu-tag bg-red radius sm font-xs font-bold"
                @click.stop="openVip">
            VIP
          </view>
