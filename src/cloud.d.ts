...
declare namespace UniCloud {
    interface Db {
         ...
         */
        collection(collName: string | DBCollectionString): CollectionReference;
        /**
         * 指定数据库操作需要执行的action
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/database?id=action](http://uniapp.dcloud.io/uniCloud/database?id=action)
         */
        action(actionName: string | ClientDBActionString): Db;
        /**
         * 获取云端环境变量
         *
    ...
    interface CollectionReference {
         ...
         */
        field(projection: string | DBFieldString): Query;
        /**
         * 指定返回结果中记录需返回的字段
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=指定返回字段](http://uniapp.dcloud.io/uniCloud/cf-database?id=指定返回字段)
         */
        preField(projection: string | DBFieldString): Query;
        /**
         * 指定分组依据
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/clientdb?id=groupby](http://uniapp.dcloud.io/uniCloud/clientdb?id=groupby)
         */
        groupBy(projection: string | DBFieldString): Query;
        /**
         * 指定统计指标
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/clientdb?id=groupby](http://uniapp.dcloud.io/uniCloud/clientdb?id=groupby)
         */
        groupField(projection: string | DBFieldString): Query;
        /**
    ...
    interface DocumentReference {
         ...
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=指定返回字段](http://uniapp.dcloud.io/uniCloud/cf-database?id=指定返回字段)
         */
        field(projection: string | DBFieldString): DocumentReference;
        /**
         * 指定返回结果中记录需返回的字段
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=指定返回字段](http://uniapp.dcloud.io/uniCloud/cf-database?id=指定返回字段)
    ...
    interface Query {
         ...
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=查询文档](http://uniapp.dcloud.io/uniCloud/cf-database?id=查询文档)
         */
        get(getOne: boolean, getCount: boolean): Promise;
        /**
         * 统计匹配查询条件的记录的条数
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=获取查询数量](http://uniapp.dcloud.io/uniCloud/cf-database?id=获取查询数量)
    ...
    interface AggregateCommand {
         ...
         */
        objectToArray(objectToArrayOptions: AnyObject | string): any [];
        /**
    ...
    interface LogicCommand {
         ...
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=and](http://uniapp.dcloud.io/uniCloud/cf-database?id=and)
         */
        and(__expressions__: None): LogicCommand;
        /**
         * 查询操作符，用于表示逻辑 "或" 的关系，表示需同时满足多个查询筛选条件。或指令有两种用法，一是可以进行字段值的 “或” 操作，二是也可以进行跨字段的 “或” 操作。
         *
         * 文档: [http://uniapp.dcloud.io/uniCloud/cf-database?id=or](http://uniapp.dcloud.io/uniCloud/cf-database?id=or)
         */
        or(__expressions__: None): LogicCommand;
    }
    ...
    interface UniCloud {
         ...
         */
        callFunction(options: CallFunctionOptions): Promise;
        /**
         * 上传文件到云端
         *
         ...
         * 选择并上传文件
         */
        chooseAndUploadFile(options: ChooseAndUploadFileOptions): Promise;
        /**
         * 删除云端文件
         *
         ...
         */
        on(eventName: string, callbaack: (result: any) => void): Promise;
    }
