  ...
  <view class="bg-white">
    <q-row v-if="user">
      <view class="row-col-center">
        ...
        <text class="ml-xs font-mdd font-bold">
          贝壳余额：
        </text>
      </view>
      <text class="row-col-center font-mdd font-bold">
        {{user.shell}}
      </text>
    </q-row>
    <q-row>
      <text class="font-mdd font-bold">
        充值：
      </text>
    </q-row>
    <view class="px">
      ...
      <button class="bg-green-light text-white font-mdd bd-none mt bg-active round" @click="userPay">
        <!--  #ifdef MP -->
        充值
        <!--  #endif -->
        <!--  #ifndef MP -->
    ...
    <q-row>
      <view class="w100p flex-col">
        ...
        <view class="pt-xs">
          ...
          <view v-else class="font-mdd text-gray row-center">暂无</view>
        </view>
      </view>
    </q-row>
  </view>
