<template>
  <view>
    ...
    <view class="article">
      <view class="text-lg">1.用户每次观看视频广告
      ...
      <view class="text-lg">2.爱心值会展示在用户动态中</view>
      <view class="text-lg">3.未来爱心值将支持更多使用方式</view>
      <view class="text-lg">4.最终解释权归本公司所有</view>
    </view>
    <view class="article-row">
